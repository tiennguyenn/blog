...
import bg from './../assets/images/post-bg.jpg'
...
const Post = () => {
  ...
  console.log(posts, index, post)

  return (
    <>
      <Header bg={bg} heading={post.title} subheading={post.subtitle} isPost user={post.user} createdAt={post.created_at} />
      <article>
        <div className="container">
          <div className="row">
            <div className="col-lg-8 col-md-10 mx-auto">
              ...
              <a href="/post">
                <img className="img-fluid" src="img/post-sample-image.jpg" alt="Sample" />
              </a>
